...
def main(args):
    ...
    freq_range=mp.FreqRange(min=1/4,max=1/0.2)#wavelength range to consider for the dispersion model is 0.2-4 um
    #freq_range=[1/x for x in wavelength_range]#corresponding frequency range for the dispersion model
...
if __name__ == '__main__':
    ...
    parser.add_argument('-output_gif', type=bool, default=True, help='Boolean to output a field profile gif or not')
