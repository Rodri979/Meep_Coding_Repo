function spit_fire_plotter(directory, mode_data, eps_file)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for graph_index = linspace(1, length(pic_names(:,1)), length(pic_names(:,1)))
    Plot_3d_w_black_lines(eps_file, "/eps", "/scratch/bell/rodri979/meep_files/matlab/" + directory + "/kz_" + pic_names(graph_index, 1) + "/" + pic_names(graph_index, 3), "/denergy", "x", 25, true, "|E| at z=25 for k=" + pic_names(graph_index, 1) + " and w=" + pic_names(graph_index, 2))
end
