%% BPM-MATLAB MACH-ZEHNDER INTERFEROMETER (MZI)
%{
...
1um high. It is 16um long in total and consists of 7 segments:
    ...
    Consist of four 5um-radius arcs. The first two split the e-field,
    facing right and left, and the later two straight the field again,
    facing forward;
